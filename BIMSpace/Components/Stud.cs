...
namespace BIMSpace.Components
{
    public class Stud
    {
        ...
        public Stud(Model model,float x,float y,float z,float xDim,float yDim,float height,string name)
        {
            Model = model;
        ...
        public Stud(Model model,Location location,Dimension dimension,string name):this(model,location.X,location.Y,location.Z,dimension.XDIM,dimension.YDIM,dimension.Height,name)
        {
        ...
        public IfcColumnStandardCase New( string name)
        {
            

            using (var txn = model.BeginTransaction("New Stud"))
            {
